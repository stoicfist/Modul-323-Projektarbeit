...
Der hohe F-Wert deutet darauf hin, dass sich die Mittelwerte der Gruppen
...
Die Varianzanalyse wird in diesem Projekt ausschließlich deskriptiv
verwendet; auf einen formalen Signifikanztest wird bewusst verzichtet.
...
\newline
\textit{Hinweis:} Der vollständige Quellcode befindet sich im Projekt-Repository
(vgl.~\cite{github}).
Er wurde in dieser Dokumentation bewusst nicht vollständig abgedruckt, um den Fokus
auf Konzept und Vergleich zu legen.
